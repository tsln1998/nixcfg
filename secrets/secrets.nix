...
in
{
  ...
  "hosts/oracle-sin-1/k3s/root-ca.crt.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/root-ca.key.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/root-ca.pem.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/server-ca.crt.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/server-ca.key.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/server-ca.pem.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/client-ca.crt.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/client-ca.key.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/client-ca.pem.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/request-header-ca.crt.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/request-header-ca.key.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/request-header-ca.pem.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/intermediate-ca.crt.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/intermediate-ca.key.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/intermediate-ca.pem.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/service.key.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/etcd/peer-ca.crt.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/etcd/peer-ca.key.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/etcd/peer-ca.pem.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/etcd/server-ca.crt.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/etcd/server-ca.key.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/k3s/etcd/server-ca.pem.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  ...
  "hosts/oracle-sin-1/nezha.rclone.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  "hosts/oracle-sin-1/nezha-agent.yaml.age".publicKeys = hosts.oracle-sin-1 ++ users.tsln;
  ...
  "hosts/oracle-phx-1/nezha-agent.yaml.age".publicKeys = hosts.oracle-phx-1 ++ users.tsln;
